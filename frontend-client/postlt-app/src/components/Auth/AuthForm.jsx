    ...
    <div className="flex-col items-center justify-center">
      ...
      <div className="text-center mb-5">
        <h1 className="text-xl font-semibold text-gray-900">
          Welcome to <span className="text-[#28AA4A]">Postlt !</span>
        </h1>
      </div>
      {/*Form Card*/}
      <div className="card-body items-center bg-base-100 shadow-xl rounded-lg">
        ...
        <form className="space-y-1 w-72" onSubmit={onSubmit}>
          ...
          <div>
            <button
              type="submit"
              className="btn w-72 mt-2 bg-[#28AA4A] border-[#28AA4A] hover:bg-[#28AA4A] hover:bg-opacity-90 hover:border-[#28AA4A]"
            >
        ...
        <div className="flex-col items-center justify-center mt-2 text-center">
          <a
            className="text-sm text-[#28AA4A] underline cursor-pointer hover:text-opacity-70"
